-- Simplified Database Setup for CatCV (No public.users table)
-- Uses auth.users directly for user references
...
-- Create tables (using auth.users for foreign keys)
...
-- Verify setup
SELECT 'Database setup complete (without public.users table)!' as message;

-- Check tables
SELECT table_name 
FROM information_schema.tables 
WHERE table_schema = 'public' 
AND table_name IN ('resumes', 'job_descriptions', 'applications', 'application_status_history')
ORDER BY table_name;